...
export const zhTW: Strings = {
  ...
  partners: {
    ...
    statsNote: (asOf: string) =>
      `數據來自 2026 OWCS Pacific，截至 ${asOf}。所列任何轉播觀看數均為 OWCS Pacific 官方轉播的觸及，而非我們自有頻道。`,
  ...
  nextMatch: {
    ...
    min: '分',
    sec: '秒',
    yourTimezone: '你的時區', // DRAFT PENDING RIRI NATIVE REVIEW
  },
  ...
  sponsorInvite: {
    eyebrow: '合作夥伴',
    heading: '創始夥伴名額開放中',
    body: '這裡還沒有任何標誌，這是刻意的。在我們征戰 OWCS Pacific 的路上，成為第一個出現在隊服上的品牌。',
    cta: '與我們合作',
  },
  ...
  games: {
    ...
    gambit: {
      ...
      endlessTag: '無盡',
      winHeading: '你撐住了！',
      winBody: '你撐過了 10 分鐘大關。繼續進入無盡模式，或在此結束。',
      continueLabel: '繼續挑戰',
      finishLabel: '結束本局',
      unlockHeading: '解鎖新英雄',
      howToHeading: '玩法',
      ...
      heroes: {
        ...
        bishop: {
          name: '主教',
          desc: '精準的遠程射手，是純粹的脆皮輸出：暴擊強勁、射程最遠，但無法回復生命。持續走位，從安全距離外逐一擊倒敵群。',
        },
        // DRAFT PENDING RIRI NATIVE REVIEW
        knight: {
          name: '騎士',
